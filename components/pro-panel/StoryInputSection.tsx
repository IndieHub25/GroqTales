...
const ACT_STRUCTURES: ActStructure[] = [
  'three-act',
  'five-act',
  'heros-journey',
  'kishōtenketsu',
...
/** Inline story-input fields (character, title, prompt) inside the Incident dossier. */
          ...
          <select
            ...
            onChange={(e) =>
              updateParameter(
                'storyStructure',
                'narrativeStyle',
                e.target.value as NarrativeStyle
              )
            }
          ...
          <select
            ...
            onChange={(e) =>
              updateParameter(
                'storyStructure',
                'actStructure',
                e.target.value as ActStructure
              )
            }
            className="w-full bg-white border-4 border-black p-3 font-condensed font-bold uppercase text-black focus:ring-0 focus:outline-none"
          >
          ...
          <select
            ...
            onChange={(e) =>
              updateParameter(
                'storyStructure',
                'resolutionStyle',
                e.target.value as ResolutionStyle
              )
            }
            className="w-full bg-white border-4 border-black p-3 font-condensed font-bold uppercase text-black focus:ring-0 focus:outline-none"
          >
