...
export const StoryCard = memo(
  ({
    ...
    const storyContent =
      story.content ||
      story.description ||
      'No teaser available. Step inside to discover the full narrative and unearth the secrets within.';
    ...
    return (
      <>
        <div
          className={cn('relative w-full', isGrid ? 'h-[420px]' : 'h-[200px]')}
        ...
        >
          <motion.div
            ...
            onClick={() =>
              isGrid ? setIsFlipped(!isFlipped) : handleViewNFT()
            }
          >
            {/* Front of Card */}
            <div
              ...
              <div className="relative z-10 flex flex-col h-full p-6 text-center">
                ...
                <div className="mt-auto pt-6 flex flex-col gap-2">
                  ...
                  {showCreateButton && (
                    ...
                    >
                      <PenSquare className="w-4 h-4 mr-2" /> Remix / Mint
                      Similar
                    </Button>
                  )}
                </div>
