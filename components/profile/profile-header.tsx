...
import { Copy, Edit, Share2, Wallet, X } from "lucide-react";
...
export function ProfileHeader({ user, isOwner, isEditing, onEditToggle }: ProfileHeaderProps) {
      ...
      <div className="container mx-auto px-4 relative z-10 pt-16 md:pt-24">
        <div className="flex flex-col md:flex-row items-center md:items-end gap-6">
          ...
          <div className="flex-1 text-center md:text-left space-y-2">
            ...
            <p className="max-w-md text-sm text-muted-foreground mx-auto md:mx-0">
          ...
          <div className="flex gap-3 mt-4 md:mt-0">
            {isOwner ? (
              <Button
                ...
                className={`gap-2 ${isEditing ? "" : "border-slate-700 hover:bg-slate-800"}`}
