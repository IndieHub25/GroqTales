    ...
    async function fetchPrivacy() {
      try {
        const res = await fetch(
          `${process.env.NEXT_PUBLIC_API_URL || ''}/api/v1/settings/privacy`
        );
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Manage how your profile and activity are seen by the GroqTales
          community.
        </CardDescription>
      </CardHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                Allow anyone to see your stories and collections.
              </p>
            </div>
            <Switch
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                Display your likes and follows on your profile.{' '}
              </p>
            </div>
            <Switch
