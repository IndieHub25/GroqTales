    ...
    <div className="w-full max-w-md px-6 py-12 relative z-10 flex flex-col">
      <div className="flex flex-col items-center mb-10">
        ...
        <h1 className="text-2xl font-semibold tracking-tight text-white mb-2">
          Sign in to GroqTales
        </h1>
        <p className="text-neutral-400 text-sm text-center">
          Manage your content, libraries, and Web3 portfolio
        </p>
      </div>
      ...
      <div className="bg-[#121214] border border-neutral-800 p-8 rounded-2xl shadow-xl w-full">
        <form onSubmit={handleSignIn} className="space-y-5">
          <div className="space-y-2">
            ...
            <div
              className={`relative flex items-center rounded-xl border transition-colors ${focusedField === 'identifier' ? 'border-neutral-500 bg-[#1c1c1f]' : 'border-neutral-800 bg-[#141417]'}`}
            >
              <svg
                className={`absolute left-4 w-4 h-4 transition-colors ${focusedField === 'identifier' ? 'text-neutral-300' : 'text-neutral-600'}`}
          ...
          <div className="space-y-2">
            ...
            >
              <Lock
                className={`absolute left-4 w-4 h-4 transition-colors ${focusedField === 'password' ? 'text-neutral-300' : 'text-neutral-600'}`}
              />
              <Input
                id="password"
