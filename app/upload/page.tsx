...
export default function UploadPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const endpoint =
        'https://groqtales-backend-api.onrender.com/api/v1/stories';
    ...
    <div className="min-h-screen bg-black text-white selection:bg-emerald-500/30">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          >
            Upload your existing manuscripts or craft them live using our
            markdown editor.
          </motion.p>
        </div>
                ...
                >
                  {isSubmitting ? (
                    ...
                    <span className="flex items-center gap-2 text-primary-foreground">
                      Publish Story <ChevronRight className="w-5 h-5" />
                    </span>
                  )}
                </Button>
                <p className="text-center text-xs text-white/40 mt-4 leading-relaxed">
                  By publishing, you agree to our Terms of Service and
                ...
                >
                  ...
                  >
                    ...
                    {file ? (
                      ...
                      <div className="flex flex-col items-center space-y-6">
                        <div
                          className={`w-24 h-24 rounded-full flex items-center justify-center transition-colors duration-300 ${isHovering ? 'bg-white text-black' : 'bg-white/10 text-white'}`}
                        >
                        ...
                        <Button
                          variant="secondary"
                          className="mt-8 px-8 h-12 rounded-xl pointer-events-none"
                        >
                          Browse Files
                        </Button>
                      </div>
