      ...
      >
        <div className="flex flex-col items-center mb-10 text-center">
          ...
          <p className="text-white/50 text-sm max-w-[280px]">
            Log in to access your library, royalties, and AI tools.
          </p>
        </div>
        ...
        <div className="bg-white/5 border border-white/10 p-8 rounded-3xl shadow-2xl backdrop-blur-xl relative overflow-hidden">
          ...
          <form onSubmit={handleSignIn} className="space-y-4 relative z-10">
            <div className="space-y-1.5">
              ...
              <div
                className={`relative flex items-center transition-all duration-300 rounded-2xl border ${focusedField === 'identifier' ? 'border-white/40 bg-white/10' : 'border-white/10 bg-white/5'}`}
              >
                <Mail
                  className={`absolute left-4 w-4 h-4 transition-colors duration-300 ${focusedField === 'identifier' ? 'text-white' : 'text-white/40'}`}
                />
                <Input
                  id="identifier"
                  type="text"
            ...
            <div className="space-y-1.5">
              ...
              <div
                className={`relative flex items-center transition-all duration-300 rounded-2xl border ${focusedField === 'password' ? 'border-white/40 bg-white/10' : 'border-white/10 bg-white/5'}`}
              >
                <Lock
        ...
        <p className="mt-8 text-center text-sm text-white/50 font-medium">
          ...
          <Link
            href="/sign-up"
            className="text-white hover:text-blue-400 transition-colors ml-1 border-b border-transparent hover:border-blue-400 pb-0.5"
          >
            Create One
          </Link>
        </p>
