    ...
    <div className="min-h-screen bg-background dark:dark-premium-bg relative overflow-x-hidden selection:bg-primary/30">
      ...
      <div className="container max-w-4xl mx-auto px-4 py-12 md:py-20">
        ...
        <header className="mb-16 text-center lg:text-left">
          ...
          <h1
            className="text-4xl md:text-5xl lg:text-7xl font-extrabold tracking-tight mb-8 leading-[1.1] text-transparent bg-clip-text bg-gradient-to-br from-white via-white to-white/60 drop-shadow-sm font-display"
        ...
        <div className="relative w-full aspect-video md:aspect-[21/9] rounded-2xl md:rounded-[32px] overflow-hidden mb-16 border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.5)] group transform-3d">
          ...
          <div className="absolute bottom-6 left-6 z-20 flex gap-2">
            <span className="px-3 py-1 rounded bg-black/60 backdrop-blur-md border border-white/10 text-xs font-semibold text-white/80 uppercase tracking-wider">
              #AI
            </span>
            <span className="px-3 py-1 rounded bg-black/60 backdrop-blur-md border border-white/10 text-xs font-semibold text-white/80 uppercase tracking-wider">
              #Web3
        ...
        {/* Article Body */}
        <article
          className="text-lg md:text-xl max-w-none 
        ...
        >
          <p
            className="lead text-xl md:text-2xl text-foreground/90 font-medium mb-12"
            style={{ fontFamily: 'var(--font-comic)' }}
          >
            You think "Write a noir heist set in a neon Delhi, mint it on-chain,
            split royalties with my co-writer, and don't make me touch a smart
            contract." That's the experience we're trying to build with
            GroqTales.
          </p>

          <p>
            Most NFT projects treated lore as marketing copy. The PFPs got all
            the liquidity; the writers got a Notion doc and a "thanks fam".
          </p>
          <p>
            So we asked: what if the <strong>story</strong> was the first-class
            asset? And what if AI + on-chain rails made it fast to create, fair
            to share, and transparent to curate?
          </p>
          <p>
            This post is the story of how we're building that — and where you
            can plug in as a contributor.
          </p>
          ...
          <ul>
            <li>
              You describe a story (or go full control-freak with an advanced
              "Pro Panel" of ~70 knobs).
            </li>
            <li>
              Groq models generate a structured screenplay-like narrative in
              seconds.
            </li>
            <li>
              We pair it with AI-generated visuals to feel like a comic /
              graphic novel.
            </li>
            <li>
              You mint it as an NFT on Monad, with collaborators and royalty
              splits encoded in the CollabStory Protocol.
            </li>
          </ul>
          ...
          <div className="flex flex-col sm:flex-row gap-4 my-10 p-6 rounded-2xl bg-white/5 border border-white/10 shadow-lg backdrop-blur-sm">
            <div className="flex-1 flex flex-col justify-center">
              <h3 className="text-xl font-bold mb-2 !mt-0">
                Try the current build here:
              </h3>
              <div className="flex flex-wrap gap-4 mt-2">
                <a
                  href="https://www.groqtales.xyz/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-lg font-bold text-sm hover:scale-105 transition-transform shadow-[0_4px_14px_rgba(255,77,109,0.4)] no-underline"
                >
                  Live site
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-[#24292e] text-white rounded-lg font-bold text-sm hover:scale-105 transition-transform shadow-lg no-underline border border-white/10"
                >
          ...
          <p>
            The obvious implementation would be a single prompt field and a
            "Generate" button. We didn't do that.
          </p>
          <p>
            Instead, we built a Pro Panel UI that turns story generation into a
            structured system:
          </p>
          <ul>
            <li>
              <strong>9 logical categories</strong> (Story Structure,
              Characters, World, Tone & Style, Theme, Model Settings, Visual,
              Length, Advanced).
            </li>
            <li>
              <strong>~70 parameters</strong> persisted in a Zustand store with
              localStorage.
            </li>
            <li>
              <strong>A grid of genre cards</strong> (Fantasy, Noir, Cyberpunk,
              Romance, etc.) that act more like story presets than mere labels.
            </li>
            <li>
              <strong>A dossier-style layout</strong> with animated "page turns"
              so power-users don't drown in sliders.
            </li>
          </ul>

          <p>Rough shape of the state:</p>
          <pre>
            <code>{`// src/store/proPanelStore.ts
type ProParameters = {
  ...
  advanced: { /* safety rails, output schema... */ };
          ...
          <ul>
            <li>
              Presets (built-in and user-defined) that snapshot the entire
              parameter tree.
            </li>
            <li>
              Import / export flows using JSON (so you can share a "Cyberpunk
              Heist" config in Discord).
            </li>
            <li>
              Validation using Zod schemas to keep the Groq API calls sane.
            </li>
            <li>
              Accessible controls (labels, keyboard nav, aria semantics) so this
              isn't just "pretty sliders".
            </li>
          </ul>
          <p>
            The Pro Panel isn't "UX sugar" — it's our contract for generating
            consistent, remixable stories.
          </p>
          ...
          <ol>
            <li>
              Receives <code>{`{ prompt, title, proConfig }`}</code> at{' '}
              <code>/api/groq</code>.
            </li>
            <li>
              Validates <code>proConfig</code> against strict Zod schemas.
            </li>
            <li>
              Compiles a system prompt that encodes:
              <ul>
            ...
            <li>
              Calls the Groq chat completions endpoint with hardened settings.
            </li>
          ...
          <p>
            The second pillar: a story is an NFT, not a random JSON blob on some
            server. We're integrating Monad as the base chain for story minting.
            Design goals:
          </p>
          <ul>
            <li>
              <strong>1 story = 1 NFT.</strong>
            </li>
            <li>
              Each NFT references:
              <ul>
                ...
                <li>
                  A list of contributors with weights (writer, editor, artist,
                  prompt engineer...).
                </li>
              </ul>
            </li>
...
function mintStory(
  ...
  ContributorShare[] memory shares
) external returns (uint256 tokenId);`}</code>
          </pre>

          <p>
            On the AI side, we're responsible for producing a canonical JSON
            representation of the story, verifying contributors, and exposing a
            UX where non-crypto-native writers don't have to think about any of
            this.
          </p>

          <h2>Curation: AIgent Curators instead of black‑box feeds</h2>
          <p>
            Ranking content is where most creator platforms quietly betray their
            users.
          </p>
          <p>
          ...
          <ul>
            <li>
              <strong>Transparent</strong> (inputs + scoring dimensions are
              inspectable).
            </li>
            <li>
              <strong>Logged on-chain</strong> (or at least hash-committed).
            </li>
            <li>
              <strong>Tunable</strong> per community (e.g., "give me weird
              experimental horror" vs "keep it PG-13 fantasy").
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  Genre fit (does this actually feel like "Noir Heist" or just
                  generic copypasta?).
                </li>
          ...
          <ul>
            ...
            <li>
              Accessibility passes (labels, aria, focus states) guided by
              automated review.
            </li>
          </ul>
          ...
          <ul>
            <li>
              Route handlers under <code>/app/api/*</code>:
              <ul>
                <li>
                  <code>/api/groq</code> for story generation with Pro Panel
                  config.
                </li>
                <li>
                  (Planned) <code>/api/story</code> endpoints for persistence,
                  remixing, and publishing.
                </li>
              </ul>
            </li>
            <li>
              <code>lib/groq-service.ts</code> acting as the AI "engine" layer.
            </li>
          ...
          <p>
            This is open source by design. I don't want this to become "yet
            another closed AI content farm". If any of these sound like your
            thing, you can make a real dent:
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 my-10 not-prose">
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-primary/50 transition-colors shadow-lg">
              <h3 className="text-lg font-bold text-white mb-3 flex items-center gap-2">
                <span className="text-primary text-xl">1.</span> AI / Prompt
                Engineering
              </h3>
            ...
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-primary/50 transition-colors shadow-lg">
              <h3 className="text-lg font-bold text-white mb-3 flex items-center gap-2">
                <span className="text-primary text-xl">2.</span> Smart Contracts
                / Monad
              </h3>
              <ul className="space-y-2 text-sm text-foreground/80 list-disc list-inside">
            ...
            <div className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-primary/50 transition-colors shadow-lg">
              ...
              <ul className="space-y-2 text-sm text-foreground/80 list-disc list-inside">
                ...
                <li>
                  Build a reader experience that feels like turning comic pages.
                </li>
          ...
          <ol className="space-y-4">
            <li>
              <strong>Explore the platform:</strong> Open{' '}
              <a href="https://www.groqtales.xyz">groqtales.xyz</a> and poke
              around the Pro Panel. Break it. See where it feels clunky or
              magical.
            </li>
            <li>
              <strong>Star & watch the repo:</strong> Stars genuinely help
              surface the project to other builders. Give it a star{' '}
              <a href="https://github.com/IndieHub25/GroqTales">on GitHub</a>.
            </li>
            <li>
              <strong>Pick an issue and ship a PR:</strong> Check the issues
              board in the repo. Comment that you're taking something so we
              don't collide. Open a focused PR.
            </li>
            <li>
              <strong>Propose experiments:</strong> Want to try a new model, a
              different chain, or a wild curator idea? Open a discussion or
              issue. This is meant to be a playground.
            </li>
          </ol>

          <blockquote className="text-xl">
            If you've ever looked at an NFT drop and thought, "the art is cool
            but the story deserved better" — GroqTales is my attempt to fix
            that.
          </blockquote>

          <p>
            Writers, prompt-engineers, and devs shouldn't be NPCs in the creator
            economy. They should be main characters with on-chain receipts.
          </p>
