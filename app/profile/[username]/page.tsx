...
export default function ProfilePage() {
  ...
  const isOwner = account?.toLowerCase() === walletFromUrl?.toLowerCase();
          ...
          <div className="lg:col-span-1 space-y-6">
            <Card className="border-2 border-slate-200 dark:border-slate-800 shadow-[8px_8px_0px_0px_rgba(0,0,0,0.1)] dark:shadow-none overflow-hidden">
              <div className="p-6 flex flex-col items-center text-center">
                      ...
                      <div className="relative cursor-pointer transition-opacity hover:opacity-90">
                        <Avatar className="w-32 h-32 border-4 border-background shadow-xl">
                          ...
                          <AvatarFallback className="text-3xl font-bold bg-slate-100 dark:bg-slate-800">
                            {userData.name ? userData.name.slice(0, 2).toUpperCase() : 'AU'}
                          </AvatarFallback>
                        </Avatar>
                ...
                <h1 className="text-2xl font-black uppercase italic tracking-tight mb-1">{userData.name || 'Anonymous User'}</h1>
                ...
                {userData.walletAddress && (
                  <Badge variant="outline" className="mb-4 bg-slate-100 dark:bg-slate-800 font-mono text-xs">
