  ...
  const marqueeGenres = [
    {
      ...
      image:
        'https://ik.imagekit.io/panmac/tr:f-auto,w-740,pr-true//bcd02f72-b50c-0179-8b4b-5e44f5340bd4/175e79ee-ed99-45d5-846f-5af0be2ab75b/sub%20genre%20guide.webp',
      color: 'from-cyan-500 to-blue-600',
    },
    {
      name: 'Fantasy',
      image:
        'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhv_45322WkBmu9o8IvYfcxEXDTbGzORCAgwdP0OF1Zq4izhDr6PT-bkqYj0BJJ_HP02Op2Y0vrNOQlN6tuf0cnu4GwWqprIJrcn89pYY6uiu89gXLr5UXIZ3h6-2HWvO-SjaqzeMRoiXk/s1600/latest.jpg',
    ...
    {
      name: 'Horror',
      image: 'https://www.nyfa.edu/wp-content/uploads/2022/11/nosferatu.jpg',
    ...
    },
    {
      ...
      image:
        'https://celadonbooks.com/wp-content/uploads/2020/03/Historical-Fiction-scaled.jpg',
      color: 'from-yellow-700 to-yellow-900',
    },
    {
      name: 'Young Adult',
      image:
        'https://advicewonders.wordpress.com/wp-content/uploads/2014/09/ya.jpg',
      color: 'from-pink-400 to-pink-600',
    },
    {
      name: 'Comedy',
      image:
        'https://motivatevalmorgan.com/wp-content/uploads/2021/01/Why-Comedy-is-a-Genre-for-All.png',
      color: 'from-yellow-400 to-yellow-600',
    },
    {
      name: 'Dystopian',
      image:
        'https://storage.googleapis.com/lr-assets/shared/1655140535-shutterstock_1936124599.jpg',
      color: 'from-purple-800 to-black',
    },
    {
      name: 'Historical Fantasy',
      image:
        'https://upload.wikimedia.org/wikipedia/commons/1/16/The_violet_fairy_book_%281906%29_%2814566722029%29.jpg',
      ...
      >
        ...
        <div className="container mx-auto px-6 relative z-10 flex flex-col items-center max-w-5xl">
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="text-center mt-20 md:mt-0 flex flex-col items-center"
          >
            <motion.div
              variants={fadeUp}
              className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 mb-8 backdrop-blur-md"
            >
            ...
            <motion.h1
              variants={fadeUp}
              className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter leading-[1.2] pb-4 mb-6"
            >
              Write your{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-emerald-400 py-2 inline-block">
                legacy.
              </span>
              <br />
              Own your{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400 py-2 inline-block">
                universe.
              </span>
            </motion.h1>
            ...
            <motion.div
              variants={fadeUp}
              className="min-h-[6rem] mb-10 max-w-2xl mx-auto flex items-center justify-center"
            >
            ...
            >
              <Button
                asChild
                className="group relative overflow-hidden bg-white text-black hover:text-black h-16 px-10 rounded-full font-bold text-lg transition-all hover:scale-105 active:scale-95 shadow-[0_0_40px_rgba(255,255,255,0.2)]"
              >
                <Link href="/create">
              ...
              <UploadStoryTrigger
                variant="outline"
                className="h-16 px-10 rounded-full font-bold text-lg border-white/20 hover:bg-white/10 text-white shadow-[0_0_20px_rgba(255,255,255,0.05)]"
                buttonText="Upload Existing Story"
                icon={false}
              />
            </motion.div>
          </motion.div>
          ...
          >
            <div className="flex flex-col md:flex-row items-end justify-between gap-8">
              <div className="max-w-2xl">
                ...
                <motion.h2
                  variants={fadeUp}
                  className="text-4xl md:text-5xl font-serif font-bold tracking-tight text-white mb-4"
                >
                  The Path to Creation
                </motion.h2>
                <motion.p variants={fadeUp} className="text-white/60 text-lg">
                  Bring your stories to life with our streamlined, professional
                  platform. No technical barriers—just your imagination paired
                  with our collaborative tools.
                </motion.p>
              </div>
              <motion.div variants={fadeUp} className="flex-shrink-0">
                <Button
                  asChild
                  className="rounded-full px-8 bg-white text-black hover:bg-white/90 font-medium"
                >
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                ...
                <div>
                  ...
                  <p className="text-lg text-white/50 max-w-lg leading-relaxed">
                    Write freely in our professional Markdown editor or upload
                    your existing documents directly. The canvas is yours to
                    command with distraction-free tools.
                  </p>
                </div>
              </div>
            </motion.div>
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                ...
                <div>
                  ...
                  <p className="text-base text-black/70 leading-relaxed">
                    Transform your raw text into beautifully structured lore
                    automatically. Let our suite handle the formatting logic
                    while you focus on the creative narrative.
                  </p>
                </div>
              </div>
            </motion.div>
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/50 leading-relaxed">
                    Secure your intellectual property automatically. Every
                    completed manuscript is permanently anchored to the
                    blockchain, ensuring your authorship is undeniable.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex-1 relative z-10">
                ...
                <p className="text-base text-white/50 leading-relaxed mb-6">
                  Distribute your completed tales to our global marketplace
                  instantly. Connect with readers, collectors, and fellow
                  creators effortlessly.
                </p>
                <Button
                  variant="link"
                  asChild
                  className="text-emerald-400 p-0 h-auto hover:text-emerald-300 font-medium group"
                >
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <div>
              <motion.h2
                variants={fadeUp}
                className="text-3xl md:text-5xl font-bold tracking-tight mb-2 flex items-center gap-3"
              >
                <TrendingUp className="text-red-500 w-8 h-8" /> Trending Now
              </motion.h2>
              <motion.p variants={fadeUp} className="text-white/50 text-lg">
                Collect the most viral lore.
              </motion.p>
            </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-2">
                Discover <span className="text-purple-400">Worlds</span>
              </h2>
              <p className="text-white/50 text-lg max-w-xl">
                Step through the portal to experiences unknown.
              </p>
            </div>
            <Button
              asChild
              variant="outline"
              className="rounded-full border-white/10 hover:bg-white/10 text-white w-fit"
            >
              <Link href="/genres">
                View All Genres <ArrowRight className="ml-2 w-4 h-4" />
              </Link>
            </Button>
          </div>
        </div>
        ...
        >
          <div className="flex w-max animate-marquee gap-6 px-6">
            ...
            {[...marqueeGenres, ...marqueeGenres].map((genre, i) => (
              <Link
                key={i}
                href={`/genres?genre=${genre.name.toLowerCase()}`}
                className="block group flex-shrink-0 w-[280px] md:w-[320px]"
              >
                <div className="relative h-64 md:h-72 rounded-3xl overflow-hidden border border-white/10">
                  ...
                  />
                  <div
                    className={`absolute inset-0 bg-gradient-to-t ${genre.color} mix-blend-multiply opacity-60 group-hover:opacity-80 transition-opacity`}
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent opacity-80" />

                  <div className="absolute inset-0 p-6 flex flex-col justify-end">
                    <h3 className="text-2xl font-bold text-white mb-2 drop-shadow-md group-hover:translate-x-1 transition-transform">
                      {genre.name}
                    </h3>
      ...
      <section className="relative py-32 bg-zinc-950 border-t border-white/5 overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            <motion.p
              variants={fadeUp}
              className="text-white/50 text-lg md:text-xl font-medium max-w-2xl mx-auto mb-10"
            >
              Join visionary creators crafting on the world's fastest
            ...
            >
              <Button
                asChild
                className="h-16 px-10 rounded-full font-bold text-lg bg-emerald-500 hover:bg-emerald-400 text-black border border-emerald-400/50 shadow-[0_0_30px_rgba(16,185,129,0.3)] transition-all hover:scale-105 active:scale-95"
              >
                <Link href="/create">
              ...
              <UploadStoryTrigger
                variant="outline"
                className="h-16 px-10 rounded-full font-bold text-lg"
                buttonText="Upload Existing Story"
                icon={false}
              />
            </motion.div>
