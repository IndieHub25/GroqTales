      ...
      <section className="relative py-32 border-t border-white/5 bg-zinc-950">
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          >
            ...
            >
              The Path to{' '}
              <span className="text-emerald-400 font-light">Creation</span>
            </motion.h2>
          </motion.div>
            ...
            {howItWorks.map((item, index) => (
              ...
              >
                <div className="flex-shrink-0 flex items-center justify-center w-16 h-16 rounded-xl bg-black border border-white/10 group-hover:border-emerald-500/50 transition-colors shadow-2xl">
                  <span className="font-mono text-xl text-white/40 group-hover:text-emerald-400 transition-colors">
                    {item.step}
                  </span>
                </div>

                <div className="flex-grow">
                  <h3 className="text-2xl font-bold text-white/90 tracking-tight mb-2 group-hover:text-white transition-colors">
                    {item.title}
                  </h3>
