    ...
    async function fetchData() {
      try {
        ...
        const prsRes = await fetch(
          `https://api.github.com/search/issues?q=repo:${REPO_OWNER}/${REPO_NAME}+type:pr+state:open`
        );
        ...
        setStats({
          ...
          openIssues:
            (repoData.open_issues_count || 0) - (prsData.total_count || 0),
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            <Badge
              variant="outline"
              className="mb-4 border-blue-500/50 text-blue-400 px-4 py-1 rounded-full bg-blue-500/5"
            >
            ...
            <p className="text-white/60 text-lg max-w-2xl mx-auto leading-relaxed">
              Meet the incredible developers and dreamers who are building the
              future of Web3 storytelling. Our project thrives because of this
              amazing community.
            </p>
          </motion.div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-12">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <Link
                href={`https://github.com/${REPO_OWNER}/${REPO_NAME}/blob/main/CONTRIBUTING.md`}
                target="_blank"
              >
                Start Contributing
              </Link>
                ...
                <Card className="group bg-white/5 border-white/10 backdrop-blur-sm hover:border-blue-500/50 transition-all duration-500 h-full overflow-hidden relative">
                  ...
                  <CardContent className="p-6 pt-2 text-center">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-2">
                      <Badge
                        variant="secondary"
                        className="bg-white/5 hover:bg-white/10 text-white/70 border-white/10"
                      >
                        {contributor.type}
                      </Badge>
        ...
        >
          ...
          <p className="text-white/60 text-lg max-w-2xl mx-auto mb-10">
            GroqTales is an open-source project and we're always looking for
            talented developers, designers, and writers to help us shape the
            future of Web3.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Button
              size="lg"
              variant="outline"
              className="rounded-full px-8 border-white/20 bg-white/5 hover:bg-white/10 font-bold"
              asChild
            >
