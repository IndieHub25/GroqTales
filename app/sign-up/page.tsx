    ...
    <div className="min-h-[calc(100vh-80px)] w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] -mt-6 -mb-6 flex items-center justify-center overflow-hidden bg-black text-white selection:bg-white/20 pt-14 pb-14">
      ...
      <div className="w-full max-w-[500px] px-6 relative z-10">
        <div className="flex flex-col items-center mb-8 text-center">
          <Link
            href="/"
            className="group relative w-16 h-16 block mb-6 outline-none rounded-full"
          >
            <motion.div
          ...
          <h1 className="text-3xl tracking-tight font-medium text-white mb-2">
            Join GroqTales
          </h1>
            ...
            {step === 'role' ? (
                ...
                <div className="grid grid-cols-1 gap-4 mb-8">
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div
                        className={`p-3 rounded-xl ${selectedRole === 'creator' ? 'bg-blue-500 text-white' : 'bg-white/10 text-white/70 group-hover:text-white'}`}
                      >
                      ...
                      <div>
                        ...
                        <p className="text-xs text-white/50 mt-1">
                          I want to write stories and mint NFTs
                        </p>
                      </div>
                    </div>
                  </button>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div
                        className={`p-3 rounded-xl ${selectedRole === 'collector' ? 'bg-purple-500 text-white' : 'bg-white/10 text-white/70 group-hover:text-white'}`}
                      >
                      ...
                      <div>
                        ...
                        <p className="text-xs text-white/50 mt-1">
                          I want to discover, read, and collect stories
                        </p>
                      </div>
                    </div>
                  </button>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div
                        className={`p-3 rounded-xl ${selectedRole === 'both' ? 'bg-emerald-500 text-white' : 'bg-white/10 text-white/70 group-hover:text-white'}`}
                      >
                      ...
                      <div>
                        ...
                        <p className="text-xs text-white/50 mt-1">
                          I want the full GroqTales experience
                        </p>
                      </div>
                    </div>
                  </button>
              ...
              >
                ...
                >
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      <Label
                        htmlFor="firstName"
                        className="text-[11px] font-semibold uppercase tracking-wider text-white/60 ml-1"
                      >
                        First Name
                      </Label>
                      <div
                        className={`relative flex items-center transition-all duration-300 rounded-xl border ${focusedField === 'firstName' ? 'border-white/40 bg-white/10' : 'border-white/10 bg-white/5'}`}
                      >
                        <Input
                          id="firstName"
                          type="text"
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div
                        className={`relative flex items-center transition-all duration-300 rounded-xl border ${focusedField === 'lastName' ? 'border-white/40 bg-white/10' : 'border-white/10 bg-white/5'}`}
                      >
                        <Input
                          id="lastName"
                          type="text"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div
                      className={`relative flex items-center transition-all duration-300 rounded-xl border ${focusedField === 'username' ? 'border-white/40 bg-white/10' : 'border-white/10 bg-white/5'}`}
                    >
                      <User
                        className={`absolute left-4 w-4 h-4 transition-colors duration-300 ${focusedField === 'username' ? 'text-white' : 'text-white/40'}`}
                      />
                      <Input
                        id="username"
                        type="text"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div
                      className={`relative flex items-center transition-all duration-300 rounded-xl border ${focusedField === 'email' ? 'border-white/40 bg-white/10' : 'border-white/10 bg-white/5'}`}
                    >
                      <Mail
                        className={`absolute left-4 w-4 h-4 transition-colors duration-300 ${focusedField === 'email' ? 'text-white' : 'text-white/40'}`}
                      />
                      <Input
                        id="email"
                        type="email"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div
                      className={`relative flex items-center transition-all duration-300 rounded-xl border ${focusedField === 'password' ? 'border-white/40 bg-white/10' : 'border-white/10 bg-white/5'}`}
                    >
                      <Lock
                        className={`absolute left-4 w-4 h-4 transition-colors duration-300 ${focusedField === 'password' ? 'text-white' : 'text-white/40'}`}
                      />
                      <Input
                        id="password"
                        type="password"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div
                      className={`relative flex items-center transition-all duration-300 rounded-xl border ${focusedField === 'confirmPassword' ? 'border-white/40 bg-white/10' : 'border-white/10 bg-white/5'}`}
                    >
                      <Lock
                        className={`absolute left-4 w-4 h-4 transition-colors duration-300 ${focusedField === 'confirmPassword' ? 'text-white' : 'text-white/40'}`}
                      />
                      <Input
                        id="confirmPassword"
                        type="password"
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      ...
                      <div
                        className={`relative flex items-center transition-all duration-300 rounded-xl border ${focusedField === 'bio' ? 'border-white/40 bg-white/10' : 'border-white/10 bg-white/5'}`}
                      >
                        <Input
                          id="bio"
                          type="text"
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div
                        className={`relative flex items-center transition-all duration-300 rounded-xl border ${focusedField === 'favoriteGenre' ? 'border-white/40 bg-white/10' : 'border-white/10 bg-white/5'}`}
                      >
                        <Input
                          id="favoriteGenre"
                          type="text"
                ...
                <div className="my-6 flex items-center">
                  ...
                  <span className="px-4 text-[10px] font-semibold uppercase tracking-widest text-white/40">
                    Or continue with
                  </span>
                  <div className="flex-1 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent"></div>
                </div>
        ...
        <p className="mt-8 text-center text-sm text-white/50 font-medium pb-8">
          ...
          <Link
            href="/sign-in"
            className="text-white hover:text-emerald-400 transition-colors ml-1 border-b border-transparent hover:border-emerald-400 pb-0.5"
          >
            Sign In
          </Link>
        </p>
