...
const ContactInfo = ({
  ...
  <motion.div
    ...
    className="flex items-start space-x-4 p-5 rounded-2xl bg-white/5 border border-white/10 hover:border-emerald-500/30 hover:bg-white/10 transition-all group"
  >
    ...
    <div>
      <h3 className="font-semibold text-white/50 text-sm tracking-wider uppercase mb-1">
        {title}
      </h3>
      {link ? (
        <Link
          href={link}
          className="text-base font-medium text-white hover:text-emerald-300 transition-colors"
        >
          {content}
        </Link>
      ) : (
    ...
    <div className="min-h-screen bg-black text-white selection:bg-emerald-500/30 font-sans relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-24 relative z-10 max-w-7xl">
        ...
        >
          <motion.div
            variants={fadeUp}
            className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 border border-white/10 rounded-full text-xs font-semibold tracking-wider text-emerald-400 mb-6"
          >
          ...
          >
            Whether you have a question about the protocol, need technical
            engineering support, or want to forge a creative partnership.
          </motion.p>
        </motion.div>
                ...
                {isSubmitted ? (
                  ...
                  >
                    ...
                    <p className="text-white/60 mb-10 max-w-md mx-auto text-lg">
                      Your message has been securely anchored into our network.
                      Our specialists will respond shortly.
                    </p>
                    <Button
                      onClick={() => setIsSubmitted(false)}
                      className="bg-white hover:bg-white/90 text-black rounded-full px-8 h-12 font-bold shadow-[0_0_20px_rgba(255,255,255,0.2)]"
                    >
                  ...
                  >
                    <div className="mb-8">
                      <h2 className="text-2xl font-semibold mb-2 flex items-center gap-2">
                        <Hexagon className="w-5 h-5 text-emerald-400" /> Secure
                        Terminal
                      </h2>
                      <p className="text-white/40 text-sm">
                        All entries are encrypted and transmitted directly to
                        the GroqTales support mainframe.
                      </p>
                    </div>
                    ...
                    <Form {...form}>
                      ...
                      >
                              ...
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input
                                    ...
                                    {...field}
                                    className="bg-black/50 border-white/10 focus-visible:ring-emerald-500 h-14 rounded-xl text-white placeholder:text-white/20 transition-all hover:bg-black/70"
                                  />
                                </FormControl>
                            ...
                            <FormItem>
                              ...
                              <FormControl>
                                <Textarea
                                  ...
                                  className="bg-black/50 border-white/10 focus-visible:ring-emerald-500 min-h-[160px] rounded-xl text-white placeholder:text-white/20 resize-none transition-all hover:bg-black/70 p-4"
                                  {...field}
                                />
                              </FormControl>
                              <FormMessage className="text-rose-400" />
                        ...
                        <Button
                          ...
                          className="w-full h-14 bg-emerald-500 hover:bg-emerald-400 text-black font-bold text-lg rounded-xl transition-all shadow-[0_0_30px_rgba(16,185,129,0.2)] hover:shadow-[0_0_40px_rgba(16,185,129,0.4)] group overflow-hidden relative mt-8"
                        >
                          {isSubmitting ? (
                            ...
                            <span className="flex items-center gap-2 z-10 relative text-primary-foreground group-hover:gap-3 transition-all">
                              Send Transmission{' '}
          ...
          >
            ...
            <div className="bg-black/40 border border-white/10 rounded-3xl p-8 backdrop-blur-xl relative overflow-hidden group">
              ...
              <div className="grid grid-cols-2 gap-4 relative z-10">
                <Button
                  variant="outline"
                  className="h-14 bg-white/5 border-white/10 hover:bg-white/10 hover:border-white/20 text-white rounded-xl transition-all hover:scale-[1.02]"
                  asChild
                >
                ...
                <Button
                  variant="outline"
                  className="h-14 bg-white/5 border-white/10 hover:bg-blue-500/20 hover:border-blue-500/50 hover:text-blue-400 text-white rounded-xl transition-all hover:scale-[1.02]"
                  asChild
                >
                  <Link
