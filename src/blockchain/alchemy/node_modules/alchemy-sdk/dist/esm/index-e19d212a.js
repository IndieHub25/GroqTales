    ...
    getProvider() {
        if (!this._baseAlchemyProvider) {
            this._baseAlchemyProvider = (() => __awaiter$1(this, void 0, void 0, function* () {
                const { AlchemyProvider } = yield import('./alchemy-provider-caf4ef5f.js');
    ...
    getWebSocketProvider() {
        if (!this._baseAlchemyWssProvider) {
            this._baseAlchemyWssProvider = (() => __awaiter$1(this, void 0, void 0, function* () {
                const { AlchemyWebSocketProvider } = yield import('./alchemy-websocket-provider-93581a59.js');
...
//# sourceMappingURL=index-e19d212a.js.map
=======
import { formatUnits, isHexString, hexStripZeros, hexValue } from './api/utils';
import { BigNumber } from '@ethersproject/bignumber';
import axios from 'axios';
